<?php 
  ...
  $db = new PDO('mysql:host=localhost;dbname=duomenubaze', 'root', '');
  ...
  <body>
    ...
    <form action="" method="post" class="form">
        <div class="form-container">
          <input type="text" name="task" class="form-input" placeholder="Pridėti naują užduotį">
        </div>
        <button name="submit" type="submit" class="btn">+</button>
      </form>
      <div class="list">
